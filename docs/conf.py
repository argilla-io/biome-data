...
module_dir = os.path.join(__location__, "../biome")
try:
...
try:
    from biome_allennlp import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = "biome_data-doc"
